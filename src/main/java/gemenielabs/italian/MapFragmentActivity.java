...
import com.squareup.picasso.Picasso;
    ...
    public class MapFragmentActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            // Initialize views
            mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.this_gd_map);
            ...
            if (intent.getIntExtra(CheckoutActivity.StartMapFromCheckOut, 0) > 1) {
                // Handle intent data if necessary
            }
        ...
        public void onMapReady(GoogleMap map) {
            ...
            // Set default location if customer location is not available
            ...
            if (DownloadLocationReceiver.localLat != null) {
                for (int i = 0; i < DownloadLocationReceiver.localLat.size() - 1; i++) {
                    ...
                    // Set custom info window contents for markers
